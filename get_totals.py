...
import sqlite3
from core.config import fact_date1, fact_date2, forecast_date1, forecast_date2
...
try:
    ...
    print(f"Общая сумма FACT Qliq на дату {fact_date1}: {fact_qliq_date1[0]}") # Выводим результат
    ...
    print(f"Общая сумма FACT Qliq на дату {fact_date2}: {fact_qliq_date2[0]}") # Выводим результат
    ...
    print(f"Общая сумма FACT Qoil на дату {fact_date1}: {fact_qoil_date1[0]}") # Выводим результатат
    ...
    print(f"Общая сумма FACT Qoil на дату {fact_date2}: {fact_qoil_date2[0]}") # Выводим результатат
    ...
    forecast_qliq_date1 = cursor.execute(req_forecast_qliq_date1).fetchone() # Выполняем запрос
    print(f"Общая сумма FORECAST Qliq на дату {forecast_date1}: {forecast_qliq_date1[0]}") # Выводим результат
    ...
    forecast_qliq_date2 = cursor.execute(req_forecast_qliq_date2).fetchone() # Выполняем запрос
    print(f"Общая сумма FORECAST Qliq на дату {forecast_date2}: {forecast_qliq_date2[0]}") # Выводим результат
    ...
    forecast_qoil_date1 = cursor.execute(req_forecast_qoil_date1).fetchone() # Выполняем запрос
    print(f"Общая сумма FORECAST Qoil на дату {forecast_date1}: {forecast_qoil_date1[0]}") # Выводим результат
    ...
    forecast_qoil_date2 = cursor.execute(req_forecast_qoil_date2).fetchone() # Выполняем запрос
    print(f"Общая сумма FORECAST Qoil на дату {forecast_date2}: {forecast_qoil_date2[0]}") # Выводим результат
